...
const Pledge: React.FC<PledgeProps> = ({ id, product, onContinue }) => {
  ...
  const modal = (
    <Modal onClose={showContinueModalHandler}>
      <div className={styles.continue__modal}>
        ...
        <p className={styles['continue__modal-description']}>
      ...
      <div className={styles.pledge__footer}>
        ...
        <div className={styles['pledge__footer-content']}>
          ...
          <Button
            ...
            className={styles['pledge__footer-btn']}
          >
            Continue
          </Button>
        </div>
  ...
  const description = (
    <div className={styles.pledge__description}>Pledge ${product.price} or more</div>
  );
      ...
      <Card borderColor="light">
        <div className={styles.pledge__header}>
          <input
            id={id}
            name="product"
            className={styles.pledge__radio}
            type="radio"
        ...
        <div className={styles.pledge__quantity}>
          <span className={styles['pledge__quantity-number']}>{product.quantity}</span> left
        </div>
        {showFooter && footer}
      </Card>
    </label>
